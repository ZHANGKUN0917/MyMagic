...
public class DBManager {
    ...
    private final static String DB_NAME = "MyMagicUserInfo";
    ...
    private static String getDbPath() {
        dbPath = mContext.getFilesDir().getAbsolutePath();
        dbPath = dbPath + File.separator + getAppKey() + File.separator + "7011727918U";
        Log.i("asdf", dbPath + "-=oppo");

        /*UserModel userInfo = SharedPreferencesUtils.getUserInfo(mContext);
        if(userInfo!=null){
            String currentUserId = userInfo.getData().getUserId();

            Log.i("asdf",dbPath+"-=-=oppo");
            Log.e(TAG, "DBManager dbPath = " + dbPath);
